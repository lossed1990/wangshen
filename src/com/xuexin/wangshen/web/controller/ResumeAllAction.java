...
@Controller
@RequestMapping("/test")
public class ResumeAllAction {
	
	private static Logger logger = LoggerFactory.getLogger(ResumeAllAction.class);
	
	@Resource(name="globalService")
	private GlobalService service_global;
	
	    @RequestMapping(value = "/resumeall.page", method=RequestMethod.GET)
