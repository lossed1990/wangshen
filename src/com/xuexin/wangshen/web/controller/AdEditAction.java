...
@Controller
@RequestMapping("/test")
public class AdEditAction {
	
	private static Logger logger = LoggerFactory.getLogger(AdEditAction.class);
	
	@Resource(name="globalService")
	private GlobalService service_global;
	
	    @RequestMapping(value = "/adedit.page", method=RequestMethod.GET)
